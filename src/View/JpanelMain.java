...
import controller.JpanelMainController;
...
public class JpanelMain extends JPanel {
	...
	public JpanelMain() {
		...
		JpanelMainController jpanelMainController = new JpanelMainController(table,textField);
		JLabel lblUs = new JLabel("Admin");
		...
		lblUs.setFont(new Font("SansSerif", Font.BOLD, 20));
		lblUs.setBounds(509, 13, 153, 44);
		add(lblUs);
...
//					dataDongGop(dongGop);
					jpanelMainController.dataDongGop(dongGop);
				} else {
					
//					dataKhoanThu(khoanThus);
					jpanelMainController.dataKhoanThu(khoanThus);
				}
			}
		});
...
//					searchKhoanThu(khoanThus);
					jpanelMainController.searchKhoanThu(khoanThus);
				} else {
//					searchDongGop(dongGop);
					jpanelMainController.searchDongGop(dongGop);
				}
			}
		});
		...
		lblNewLabel.setIcon(new ImageIcon(
				"C:\\Users\\LENOVO\\eclipse-workspace\\Quanly\\src\\image\\iconfinder_house-home-main-menu-start-building_3643769.png"));
